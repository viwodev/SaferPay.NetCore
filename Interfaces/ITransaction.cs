...
namespace SaferPay.Interfaces
{
    ...
    public interface ITransaction
    {
        ...
        /// <summary>
        /// <b>QueryPaymentMeans</b><br/><br/>
        /// This method may be used to query the payment means and payer data (address) after initialize and wallet redirect.
        /// </summary>
        /// <param name="request">This function may be called to retrieve information on the means of payment which was entered / chosen by the payer after the browser is redirected to the successUrl.</param>
        /// <returns></returns>
        public QueryPaymentMeansResponse QueryPaymentMeans(QueryPaymentMeansRequest request);


        /// <summary>
        /// <b>AdjustAmount</b><br/><br/>
        /// This method may be used to adjust the amount after query payment means.
        /// </summary>
        /// <param name="request">This function allows a change of the authorization amount which was originally set by Initialize. <br/>It requires a flag having been set in the Initialize and is only available in specific use cases.</param>
        /// <returns></returns>
